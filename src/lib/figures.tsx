...
export type Figure = { id: string; fig: string; type: NodeType; label: string; glow: Glow; icon: ReactNode }
...
export const FIGURES: Figure[] = [
  ...
  {
    id: 'bldg-office', fig: 'FIG. 005', type: 'building', label: 'Office', glow: 'blue',
    icon: (<>
  ...
  {
    id: 'bldg-mill', fig: 'FIG. 006', type: 'building', label: 'Industrial Mill', glow: 'orange',
    icon: (<>
  ...
  {
    id: 'bldg-unit', fig: 'FIG. 007', type: 'building', label: 'Office Unit', glow: 'magenta',
    icon: (<>
  ...
  // ── CIVIC ────────────────────────────────────────────
  {
    id: 'civic-gov', fig: 'FIG. 008', type: 'civic', label: 'Government', glow: 'blue',
    icon: (<>
  ...
  {
    id: 'civic-religious', fig: 'FIG. 009', type: 'civic', label: 'Religious', glow: 'purple',
    icon: (<>
  ...
  {
    id: 'civic-cultural', fig: 'FIG. 010', type: 'civic', label: 'Cultural', glow: 'magenta',
    icon: (<>
  ...
  {
    id: 'civic-military', fig: 'FIG. 011', type: 'civic', label: 'Military', glow: 'green',
    icon: (<>
  ...
  // ── SOCIETY ──────────────────────────────────────────
  {
    id: 'soc-startup', fig: 'FIG. 012', type: 'society', label: 'Startup Society', glow: 'orange',
    icon: (<>
  ...
  {
    id: 'soc-charter', fig: 'FIG. 013', type: 'society', label: 'Charter City', glow: 'blue',
    icon: (<>
  ...
  {
    id: 'soc-coliving', fig: 'FIG. 014', type: 'society', label: 'Co-living', glow: 'purple',
    icon: (<>
  ...
  {
    id: 'soc-dao', fig: 'FIG. 015', type: 'society', label: 'DAO', glow: 'magenta',
    icon: (<>
